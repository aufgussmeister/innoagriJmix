package com.company.innoagri.test_support;

import com.company.innoagri.InnoagriApplication;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = "com.company.innoagri.screen")
@ContextConfiguration(classes = {InnoagriApplication.class, UiTestAssistConfiguration.class})
